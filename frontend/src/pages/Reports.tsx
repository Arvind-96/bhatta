...
import type { Person, PersonFullReport, Customer, KilnVehicle, ExpenseType, Supplier, SalesAgentSummary, BrickCategory, Doctor } from "@/types";
...
function ReportsWorkspace() {
  ...
  useEffect(() => {
    ...
    api.doctors.list().then(setDoctors).catch(console.error);
