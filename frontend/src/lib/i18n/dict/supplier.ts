...
export const supplierDict: Record<string, Record<Locale, string>> = {
  ...
  "supplier.dateAddedLabel": { en: "Date", hi: "तारीख" },
  ...
  "supplier.recordSuppliesButton": { en: "Record Supplies Received", hi: "प्राप्त आपूर्ति दर्ज करें" },
  "supplier.createInvoiceButton": { en: "Create Invoice/Receipt", hi: "इनवॉइस/रसीद बनाएं" },
  "supplier.newInvoiceTitle": { en: "New supplier invoice", hi: "नया आपूर्तिकर्ता इनवॉइस" },
  "supplier.editInvoiceTitle": { en: "Edit supplier invoice", hi: "आपूर्तिकर्ता इनवॉइस संपादित करें" },
  "supplier.itemsReceivedSection": { en: "Items Received", hi: "प्राप्त सामग्री" },
  "supplier.quantityPlaceholder": { en: "Qty", hi: "मात्रा" },
  "supplier.totalBillAmountLabel": { en: "Total Bill Amount", hi: "कुल बिल राशि" },
  "supplier.amountPaidLabel": { en: "Amount Paid", hi: "भुगतान की गई राशि" },
  "supplier.dueAmountLabel": { en: "Due / Pending Amount", hi: "बकाया राशि" },
  "supplier.saveInvoice": { en: "Save invoice", hi: "इनवॉइस सहेजें" },
