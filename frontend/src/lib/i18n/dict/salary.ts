...
export const salaryDict: Record<string, Record<Locale, string>> = {
  ...
  "salary.advanceDeductedLabel": { en: "Advance/Kharchi/Medical/Festival deducted", hi: "एडवांस/खर्ची/मेडिकल/त्योहार काटा गया" },
  "salary.totalAdvanceGivenLabel": { en: "Advance given", hi: "एडवांस दिया गया" },
  "salary.totalAdvanceKharchiMedicalGivenLabel": { en: "Advance/Kharchi/Medical/Festival given", hi: "एडवांस/खर्ची/मेडिकल/त्योहार दिया गया" },
